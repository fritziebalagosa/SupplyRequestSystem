        ...
        <div class="info-card">
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="remarks" class="form-control-minimal" rows="3"></textarea>
                </div>
                <div class="form-actions">
                    <button type="submit" name="approve_request" class="btn-minimal btn-success-minimal"><i class="bi bi-check-circle"></i> Approve Request</button>
                    <button type="submit" name="reject_request" class="btn-minimal btn-danger-minimal"><i class="bi bi-x-circle"></i> Reject</button>
                </div>
            </form>
        </div>
        <?php else: ?>
