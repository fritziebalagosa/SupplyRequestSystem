...
// ✅ Check if requester already exists for this head
...
{
    if ($status) {
        $stmt = $conn->prepare("SELECT COUNT(*) FROM requests WHERE college_office_id = ? AND (status = ? OR (? = 'pending_head' AND (status = 'pending_head' OR status = 'pending_officer')))");
                            ...
                            <tbody>
                                <?php foreach ($requesters as $r): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn-minimal btn-action-view" href="../dean/view_requester.php?id=<?= $r['id'] ?>">
                            ...
                            <tbody>
                                <?php foreach ($recent_requests as $req): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn-minimal btn-action-view" href="view_request.php?id=<?= $req['id'] ?>">
                                                <i class="bi bi-eye"></i> View
                                            </a>
                                        </td>
                                    </tr>
