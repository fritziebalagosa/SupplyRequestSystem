...
<body>
    ...
    <div class="container-main">
        <a href="head_requests.php" class="back-button">
        ...
        <div class="info-card">
            ...
            <div class="info-row">
                ...
                <div class="info-value">
                    ...
                    // Since we're in head/ directory, we need to go up one level to reach uploads/
        ...
        <div class="info-card action-card">
            ...
            <form method="POST" action="head_requests.php">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" name="action" value="return" class="btn btn-secondary" id="btnReturn">
