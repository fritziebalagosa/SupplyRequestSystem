<?php
// Admin navbar include - matches responsive behavior of other user pages
if (session_status() === PHP_SESSION_NONE) session_start();

$current = basename($_SERVER['PHP_SELF']);
$base = '/SupplyRequestSystem/admin';
  ...
  <div class="container-fluid px-4">
    ...
    <div class="collapse navbar-collapse" id="navbarAdmin">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current==='manage_requests.php' || $current==='view_request.php')? 'active':'' ?>" href="<?= $base ?>/manage_requests.php">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current==='manage_users.php')? 'active':'' ?>" href="<?= $base ?>/manage_users.php">
