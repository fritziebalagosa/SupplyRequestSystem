	...
	<div class="container-fluid px-4">
		...
		<div class="collapse navbar-collapse" id="navbarLeft">
			<ul class="navbar-nav mb-2 mb-lg-0">
				...
				<li class="nav-item px-3">
					<a class="nav-link d-flex align-items-center <?= ($current==='manage_inventory.php')? 'active':'' ?>" href="<?= $base ?>/manage_inventory.php"><i class="bi bi-box-seam me-2"></i>Inventory</a>
				</li>
				<li class="nav-item px-3">
