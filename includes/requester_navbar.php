  ...
  <div class="container-fluid px-4">
    ...
    <div class="collapse navbar-collapse" id="navbarLeft">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current==='my_requests.php' || $current==='view_request.php')? 'active':'' ?>" href="<?= $base ?>/my_requests.php">
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <div class="dropdown profile-dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
            <li><a class="dropdown-item" href="/SupplyRequestSystem/requesters/profile.php">
...
<script>
// Notification mark-as-read handlers for requester navbar
(function(){
